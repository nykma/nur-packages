...
let
  pname = "onekey-wallet";
  version = "4.23.0";
  sha256 = "sha256-EMXGgrzfdLsUMR7W+szqMPsS38RZjXqoL4TODlOufXQ=";
  url = "https://web.onekey-asset.com/app-monorepo/${version}/OneKey-Wallet-${version}-linux-x86_64.AppImage";
  src = fetchurl {
    inherit url sha256;
  };
